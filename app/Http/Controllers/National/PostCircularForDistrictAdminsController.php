...
class PostCircularForDistrictAdminsController extends Controller
{
    /**
    ...
    {
        //saving circular for only district admins
        PostCircularForDistrictAdmins::create($request->all());
