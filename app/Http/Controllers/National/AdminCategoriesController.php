...
class AdminCategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data =User::where('is_active',3)->get();
        ...
        return  view('headquarters.searchUsers.deceased');
    }
    ...
    {
        $users=Transfer::GetLatest();
        return  view('headquarters.transfers.index',compact('users'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('headquarters.searchUsers.edit',compact('user','locals','districts','areas','regions','roles','languages','home_regions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.create')->with(['success1'=>'Successfully Updated']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.create')->with(['success1'=>'Successfully Deleted']);
    }
}
