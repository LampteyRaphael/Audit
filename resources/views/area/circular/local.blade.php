        ...
        <div class="panel-body">
            @if($post)
                <table class="table table-striped table-success">
                    <tr>
                            {!! Form::open(['method'=>'POST','action'=>'Area\AreaPdfShowController@localPost','class'=>'row']) !!}
                           <td>
                    ...
                    @foreach($post as $posts)
                        ...
                        <td>
                            <a class="btn btn-default btn-sm" href="{{route('APCircularGetLI',$posts->id)}}">View</a>
                        </td>
