...
@section('content')
    ...
    <div class="row">
        ...
        {!! Form::open(['method'=>'POST','action'=>'Area\AreaPostController@store','files'=>true,'class'=>'form-row', 'onsubmit'=>'return ConfirmDelete()'])!!}
...
{{--                        <div class="input-group">--}}
{{--                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>--}}
{{--                            {!! Form::text('languagess',null,['required'=>'required','class'=>'form-control']) !!}--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                            <div class="input-group">--}}
{{--                                <div class="input-group-addon"><i class="fa fa-wrench"></i></div>--}}
{{--                                {!! Form::select('role_id',[''=>'--Select Role--']+$roles,null,['class'=>'form-control','required'=>'required']) !!}--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                            <div class="input-group">--}}
{{--                                <div class="input-group-addon"><i class="fa fa-wrench"></i></div>--}}
{{--                                {!! Form::select('is_active',[''=>'--Choose Option--',1=>'Active',0=>'Not Active'],1,['class'=>'form-control','required'=>'required']) !!}--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                    <div class="">--}}
{{--                        <div class="form-group ">--}}
{{--                            {!! Form::submit('Add Member',['class'=>'btn btn-primary pull-right']) !!}--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
