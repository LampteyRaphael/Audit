                    ...
                    @if($post)
                        <table class="table table-striped mb0">
                            <thead>
                                <tr>
                                    <th colspan="3">
                                        {!! Form::open(['method'=>'POST','action'=>'Area\AreaPdfShowController@areaPost','files'=>true]) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-default btn-sm" href="{{route('AreaPostCircularshow',$posts->id)}}">View</a>
                                </td>
                                </tr>
                            @endforeach
                            </tbody>
