...
@section('content')
    ...
    <div class="panel collapse" id="post">
        ...
        <div class="panel-body">
            <table class="table table-bordered mb0">
                <tbody>
                {!! Form::open(['method'=>'POST','action'=>'Area\AreaExpenditureCategoryController@store'] ) !!}

                <tr>
                    {!! Form::hidden('area_income_categories_id',$category->id,['class'=>'form-control']) !!}
                    {!! Form::hidden('area_id',$category->area_id,['class'=>'form-control','required'=>'required']) !!}
    ...
    <div class="panel mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li>
                    <a href="{{route('AccountECArea.index')}}">{{$category->name}}</a>
                </li>
                <li>
