...
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'Area\AreaPostedChartController@monthlypost','class'=>'modal','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($districts as $district)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('PostedLocalAreaChart',$district->id)}}">{{$district->name}}</a></td>
                                <td>
                                    <?php
