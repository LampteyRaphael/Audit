...
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'Area\AreaPostedChartController@store','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($districts as $district)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('PostedLAreaChart',$district->id)}}">{{$district->name}}</a></td>
                                <td>
                                    <?php
