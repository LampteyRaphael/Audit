...
@section('dashboard')
    <li>
        <p class="navbar-text">
          Area Posted Attendance
        </p>
    </li>
@endsection
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'Area\AreaPostedChartController@attendancepost','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
                ...
                <div class="form-group">
                    <label for="date" class="control-label">  </label>
                        <div class="input-group col-md-6 col-md-offset-3">
                            ...
                            {!! Form::date('from',$month1,['class'=>'form-control']) !!}
                ...
                <div class="form-group">
                    <label for="date" class="control-label">   </label>
                        <div class="input-group col-md-6 col-md-offset-3">
                            ...
                            {!! Form::date('to',$month2,['class'=>'form-control']) !!}
                            <div class="input-group-addon bg-blue"><i class="fa fa-calendar fa-fw"></i></div>
                        </div>
        ...
        <div class="panel mb25">
            <div class="panel-heading border">
                <ol class="breadcrumb mb0 no-padding">
                    ...
                    <li>
                        <a class="btn btn-success btn-sm" href="#date" data-toggle="modal">Change date & local</a>
                    </li>
                    <li>
