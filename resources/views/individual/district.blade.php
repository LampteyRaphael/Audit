    ...
    <div>
        <div class="panel shadow mb25">
            ...
            <div class="panel-body">
                @if($post)
                <div>
                    {!! Form::open(['method'=>'POST','action'=>'Individuals\individualCircularController@districtPost']) !!}
                    <div class="col-md-2">
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($post as $posts)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-default btn-sm" href="{{route('membersAnnouncementDS',$posts->id)}}">View</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
