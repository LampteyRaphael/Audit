...
@section('content')
    ...
    {!! Form::open(['method'=>'POST','action'=>'District\DistrictMoneyController@dailypost','class'=>'modal form-inline','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
    ...
    <div class="panel">
        <div class="panel-heading">
            <ol class="breadcrumb mb0 no-padding">
                ...
                <li>{{$date}}</li>
                <li>
                    <a class="btn btn-primary btn-xs" href="#date" data-toggle="modal">Change Date</a>
                </li>
            </ol>
        </div>
