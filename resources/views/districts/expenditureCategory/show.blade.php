    ...
    <div class="panel collapse shadow" id="post">
        ...
        <div class="panel-body">
            <table class="table table-striped mb0">
                <tbody>
                {!! Form::open(['method'=>'POST','action'=>'District\DistrictExpenditureCategoryController@store'] ) !!}
...
{{--                            {!! Form::label('description','Description',['class'=>'control-label']) !!}--}}
    ...
    <div class="panel mb25 shadow">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li>
                    <a href="{{route('AccountEC.index')}}">{{$category->name}}</a>
                </li>
                <li>
                    <a href="javascript:;">Amount</a>
                </li>
                <li>
                    <a href="#post" data-toggle="collapse"  class=" btn btn-info btn-xs">Add</a>
                </li>
            </ol>
        </div>
        <div class="panel-body">
                ...
                @if($categoryAll)
                    ...
                    @foreach($categoryAll as $item)
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary btn-sm" href="{{route('AccountE.show',$item->id)}}"><i class="glyphicon glyphicon-edit"></i></a></td>
                            <td>
                                {!! Form::open(['method'=>'DELETE','action'=>['District\DistrictExpenditureController@destroy',$item->id],'onsubmit' => 'return ConfirmDelete()'])!!}
