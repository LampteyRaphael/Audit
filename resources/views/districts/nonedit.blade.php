...
@section('dashboard')
    ...
    <li>
        <p class="navbar-text">
            <a href="{{route('addnew.index')}}" class=" btn-info btn-sm">Home</a>
        </p>
    </li>
    <li>
        <p class="navbar-text">
            <a href="{{route('districtViTithe',$user->id)}}" class=" btn-info btn-sm">Tithe</a>
        </p>
    </li>
    <li>
        <p class="navbar-text">
            <a class="btn-success btn-sm" href="{{route('districtPost.edit',$user->id)}}" onclick="return ConfirmUpdate()">Edit</a>
        </p>
    </li>
...
@section('content')
    ...
    <div class="row">
        @include('includes.form_error')
        {!! Form::model($user,['method'=>'PATCH','action'=>['District\RegionDistrictController@update',$user->id],'files'=>true,'onsubmit' => 'return ConfirmUpdate()',],['class'=>'form-inline'])!!}
        ...
        <div class="panel mb25">
            <div class="panel-heading border">
                <ol class="breadcrumb mb0 no-padding">
                    ...
                    <li>
                        <a href="{{route('districtViTithe',$user->id)}}" >Tithe</a>
                    </li>
                    <li>
                        <a  href="{{route('districtPost.edit',$user->id)}}" onclick="return ConfirmUpdate()">Edit</a>
                    </li>
                </ol>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('name',null,['class'=>'form-control selectpicker','required'=>'required','placeholder'=>'FirstName/Middle Name/Surname','disabled'=>'disabled']) !!}
                        </div>
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('gender',['male'=>'Male','female'=>'Female'],null,['id'=>'gender','class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::select('languagess[]',[$user->languagess=>$user->languagess]+$languages,$user->languagess,['id'=>'languagess','disabled'=>'disabled',
                            'class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::select('mariagetype',['customary'=>'Customary','ordinance'=>'Ordinance'],null,['class'=>'form-control', 'disabled'=>'disabled',]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            {!! Form::text('spouseName',null,['class'=>'form-control','disabled'=>'disabled',]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            {!! Form::number('numberOfChildren',null,['class'=>'form-control','disabled'=>'disabled',]) !!}
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="">
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('digitalAddress',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-location-arrow"></i></div>
                                    {!! Form::text('houseaddress',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                {!! Form::text('streetname',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                {!! Form::text('landmark',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        {!! Form::label('mobileNumber1','Mobile Number1',['class'=>'control-label bold']) !!} <div class="input-group">
                            ...
                            {!! Form::text('mobileNumber1',null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-phone"></i></div>
                            {!! Form::text('mobileNumber2',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-phone"></i></div>
                            {!! Form::text('workNumber',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('whatsappNumber',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            'secondary'=>'Secondary',
                            'o level'=>'O Level',
                            'tertiary'=>'Tertiary'],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::text('courseStudied',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            [''=>'--Choose Options--',
                             ...
                             'retired'=>'Retired'
                            ],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::text('profOccupation',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-location-arrow"></i></div>
                            {!! Form::text('placeOfWork',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                            {!! Form::date('datejoinchurch',null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-location-arrow"></i></div>
                            {!! Form::text('previousdenomination',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::select('waterBaptism',['yes'=>'Yes','no'=>'No'],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::select('rightHandOfFellowship',['yes'=>'Yes','no'=>'No'],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::select('communicant',['yes'=>'Yes','no'=>'No'],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::select('holySpiritBaptism',['yes'=>'Yes','no'=>'No'],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::select('anySpiritualGift',['yes'=>'Yes','no'=>'No'],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                            {!! Form::text('pleaseIndicate',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            {!! Form::text('ordainedBy',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                            {!! Form::date('dateOrdained',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::textarea('movementGroup',null,['class'=>'form-control','rows'=>2,'disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-list-ul"></i></div>
                                {!! Form::textarea('position',null,['class'=>'form-control','rows'=>2,'disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                                {!! Form::select('is_active',[1=>'Active',0=>'Not Active'],null,['class'=>'form-control','required'=>'required','disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                {!! Form::password('password',['class'=>'form-control','id'=>'myInput','disabled'=>'disabled']) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('members_id',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::file('photo_id',null,['class'=>'form-control','disabled'=>'disabled']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-4 col-md-offset-6">
                            <div class="form-group ">
                                <button class="btn-primary btn pull-right" type="submit"  disabled='disabled'>Update</button>
                            </div>
                        </div>
                        {!! Form::close() !!}
                        <div class="col-md-1">
                            <div class="form-group">
                                {!! Form::model($user,['method'=>'DELETE','action'=>['District\RegionDistrictController@destroy',$user->id],'onsubmit' => 'return ConfirmDelete()',],['class'=>'form-inline'])!!}
                                <button class="btn-danger btn pull-right" type="submit" disabled='disabled'>Delete</button>
                                {!! Form::close() !!}
                            </div>
                        </div>
                    </div>
