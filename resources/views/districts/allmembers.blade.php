...
@section('dashboard')
    <li>
        <p class="navbar-text">{{strtoupper(Auth::user()->district->name)}} DISTRICT</p>
    </li>
@endsection
        ...
        <div class="panel mb25 shadow">
            <div class="panel-heading border">
                <ol class="breadcrumb mb0 no-padding">
                    <li>
                        <a href="javascript:;">{{Auth::user()->district->name}}</a>
                    </li>
                    <li>
...
{{--                @if($users)--}}
                    <table class="table table-striped" id="data-table">
                        <thead>
                        <a  href="{{route('DistExportingExcel')}}" class="btn btn-default btn-xs col-xl-6">Export To Excel</a>
                        <tr>
                            <th>Membership Id</th>
                            <th>Photo</th>
                            <th>User</th>
