...
@section('dashboard')
    ...
    <li>
        <p class="navbar-text">
            <a class="btn-success btn-sm" href="{{route('districtPost.edit',$user->id)}}" onclick="return update()">Edit</a>
        </p>
    </li>
@endsection
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('gender',[$user->gender=>$user->gender]+['male'=>'Male','female'=>'Female'],$user->gender,['class'=>'form-control','required'=>'required']) !!}
                                <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            </div>
                        </div>
                    </div>
                    ...
                    @elseif(Auth::user()->role_id==11)
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                                    {!! Form::select('role_id',$specialAdmins,null,['class'=>'form-control','required'=>'required']) !!}
                                </div>
                            </div>
                        </div>
                   @else
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('members_id',null,['class'=>'form-control','required'=>'required', 'placeholder'=>"+3-digit only" ]) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-md-offset-6">
                        <div class="form-group ">
                            <button class="btn-primary btn pull-right" type="submit">Update</button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <button class="btn-danger btn pull-right" type="submit">Delete</button>
                            {!! Form::close() !!}
                        </div>
                    </div>
                        </div>
