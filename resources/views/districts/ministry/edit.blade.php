...
@section('content')
    ...
    <div class="row">
        ...
        {!! Form::model($user,['method'=>'PATCH','action'=>['District\DistrictChildrenMinistryController@update',$user->id],'files'=>true,'onsubmit' => 'return ConfirmUpdate()'],['class'=>'form-inline'])!!}
            ...
            <div class="panel-body">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-1">
                            {!! Form::model($user,['method'=>'DELETE','action'=>['District\DistrictChildrenMinistryController@destroy',$user->id],'onsubmit' => 'return ConfirmDelete()',],['class'=>'form-inline'])!!}
