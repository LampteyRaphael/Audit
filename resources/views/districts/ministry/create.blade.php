...
@section('content')
    ...
    <div class="row">
        ...
        {!! Form::open(['method'=>'POST','action'=>'District\DistrictChildrenMinistryController@store','files'=>true,'class'=>'form-row', 'onsubmit'=>'return ConfirmDelete()'])!!}
        <div class="panel mb0">
                ...
                <div class="col-sm-4 hidden">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('members_id',random_int(800,999),['class'=>'form-control','required'=>'required']) !!}
                        </div>
                    </div>
                </div>
