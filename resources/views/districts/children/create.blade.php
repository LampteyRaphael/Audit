...
@section('content')
    ...
    <div class="row">
        ...
        {!! Form::open(['method'=>'POST','action'=>'ChildrenMinistryAtLocalController@store','files'=>true,'class'=>'form-row', 'onsubmit'=>'return ConfirmDelete()'])!!}
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-4">
                <div class="form-group ">
                    ...
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                        <select id="nationality" name="nationality" class="form-control selectpicker" data-live-search="true"  multiple data-max-options=>1>
