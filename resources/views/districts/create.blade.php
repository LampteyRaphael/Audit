...
@section('content')
    <div class="row">
        ...
        @include('includes.alert')
                {!! Form::open(['method'=>'POST','action'=>'District\DistrictUpCreateController@store','files'=>true])!!}
        <div class="panel mb0">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-area-chart"></i></div>
                            {!! Form::select('local_id',[''=>'--Choose Option--']+$locals,null,['class'=>'form-control','required'=>'required']) !!}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::number('members_id',null,['class'=>'form-control','required'=>'required', 'placeholder'=>"+3-digit only"]) !!}
                            </div>
                        </div>
                    </div>
