...
{!! Form::open(['method'=>'POST','action'=>'District\PostAreaCController@psotM','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
        ...
        <div class="panel shadow animated slideInDown mb25">
            <div class="panel-heading border">
                <ol class="breadcrumb mb0 no-padding">
                    ...
                    <li>
                        <a href="#" data-toggle="modal" data-target="#date"><i class="fa fa-calendar"></i>Change Date</a>
                    </li>
                </ol>
            </div>
