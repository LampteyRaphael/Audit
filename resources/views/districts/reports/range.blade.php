...
@section('content')
    ...
    {!! Form::open(['method'=>'POST','action'=>'District\PostAreaCController@rangeReportpost','class'=>'modal form-inline','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
        ...
        <div class="table-responsive">
            <div class="panel shadow animated slideInDown mb25">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped mb0 table-hover">
                            <thead>
                            <tr>
                                <th>Local Code</th>
                                <th>Local Name</th>
