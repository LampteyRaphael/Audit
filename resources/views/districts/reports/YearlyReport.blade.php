...
@section('content')
    ...
    {!! Form::open(['method'=>'POST','action'=>'District\PostAreaCController@yearReportPost','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
                ...
                <div class="form-group">
                    <label for="date" class="control-label">
                        <div class="input-group col-md-6 col-md-offset-3">
                            ...
                            <div class="input-group-addon bg-blue"><i clas a-calendar fa-fw"></i></div>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div class="panel shadow animated slideInDown mb25">
                <div class="panel-heading border">
                    <ol class="breadcrumb mb0 no-padding">
                        <li>
                            <a class="btn btn-primary btn-xs" href="#" data-target="#date" data-toggle="modal">Change Year</a>
                        </li>
                        <li>
                            <a class="#" href="#">{{$year}}</a>
                        </li>
