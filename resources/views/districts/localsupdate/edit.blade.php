...
@section('content')
    <div class="panel mb25">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($local,['method'=>'PATCH','action'=>['District\PostAreaCircularController@update',$local->id]] ) !!}
            ...
            <div class="form-group">
                <div class="form-group ">
                    {!! Form::label('date','Date Created(optional)',['class'=>'control-label']) !!}
            ...
            <div class="form-group col-lg-6">
                {!! Form::open(['method'=>'DELETE','action'=>['District\PostAreaCircularController@destroy',$local->id],'files'=>true,'onsubmit' => 'return ConfirmDelete()'] ) !!}
