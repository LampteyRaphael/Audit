...
@section('content')
    ...
    {!! Form::open(['method'=>'POST','action'=>'Locals\PostAttendanceController@attendance','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
        ...
        <div class="panel mb25">
            <div class="panel-heading border">
                <ol class="breadcrumb mb0 no-padding">
                    ...
                    <li>
                        <a class="btn btn-success btn-sm" href="#date" data-toggle="modal">Change Date</a>
                    </li>
                    <li>
                        <a class="btn btn-primary btn-sm" href="{{route('attendExcel')}}">Export to Excel</a>
                    </li>
                </ol>
            </div>
