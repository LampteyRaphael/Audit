...
@section('content')
    ...
    <div class="panel mb25">
            ...
            <div class="panel-body">
                {!! Form::model($district,['method'=>'PUT', 'action'=>['National\DistrictController@update',$district->id],'files'=>true]) !!}
                ...
                <div class="form-group col-lg-6">
                    {!! Form::model($district,['method'=>'DELETE', 'action'=>['National\DistrictController@destroy',$district->id],'files'=>true,'onsubmit' => 'return ConfirmDelete()']) !!}
