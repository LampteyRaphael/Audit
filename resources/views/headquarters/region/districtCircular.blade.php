    ...
    <div class="panel shadow mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                ...
                <li>
                    <a href="javascript:;">District Circulars</a>
                </li>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                @if($post)
                <div class="col-md-12">
                    {!! Form::open(['method'=>'POST','action'=>'National\PostCircularToDistrictController@districtPost']) !!}
                    <div class="col-md-2">
                    ...
                    <table class="table table-striped mb0">
                        ...
                        @foreach($post as $posts)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('NatDCircularPD',$posts->id)}}" onclick="return ConfirmDelete()" class="btn btn-danger btn-xs"><i class="fa fa-remove"></i></a>
                                </td>
                                <td>
                                    <a class="btn btn-default btn-sm" href="{{route('NatDCircularS',$posts->id)}}">View</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
