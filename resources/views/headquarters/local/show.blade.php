                ...
                <table class="table table-striped">
                    ...
                    @foreach($users as $user)
                        ...
                        ->format('%y years,%m months,%d days'))}}</td>
                            ...
                            <td><a class="btn btn-success btn-xs" href="{{route('Nmember',$user->id)}}"><i class="fa fa-edit"></i></a></td>
                            <td><a class="btn btn-primary btn-xs" href="{{route('admin.show',$user->id)}}"><i class="fa fa-edit"></i></a></td>
