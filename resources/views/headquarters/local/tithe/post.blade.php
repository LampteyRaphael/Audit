    ...
    <div class="row">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['method'=>'POST','action'=>'National\SearchTitheController@search','onsubmit' => 'return searchInfo()'])!!}
                ...
                <div class="col-md-12">
                    {!! Form::open(['method'=>'POST','action'=>'National\PostTitheController@store','onsubmit' => 'return ConfirmDelete()'])!!}
