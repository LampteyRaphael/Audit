...
@section('content')
    ...
    {!! Form::open(['method'=>'POST','action'=>'National\NationalTitheController@yearpost','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-responsive-sm table-sm table-small-font">
                            ...
                            <div class="table-responsive-sm">
                                &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn-link" style="color: blue" class="btn-link" href="{{route('janFeb',$id)}}">January-February</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a class="btn-link" style="color: blue" href="{{route('marApril',$id)}}">March-April</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a class="btn-link" style="color: blue" href="{{route('NmayJune',$id)}}">May-June</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a class="btn-link" style="color: blue" href="{{route('NjulyAugust',$id)}}">July-August</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a class="btn-link" style="color: blue" href="{{route('NseptOctober',$id)}}">September-October</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <a class="btn-link" style="color: blue" href="{{route('NnovDecember',$id)}}">November-December</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                @if($users)
                                            ...
                                            <td>
                                                ...
                                                @if (   number_format(
                                                    ...
                                                    ->whereYear('created_at',$year)->whereMonth('created_at',$a)
                                                      ->skip(0)->take(1)
                                                  ->where('local_id',$id)->pluck('amount')->sum(),2)==0.00)
                                              ...
                                              App\PostTithe::orderBy('created_at','asc')->where('user_id', $user_id->id)
                                                  ->whereYear('created_at',$year)->whereMonth('created_at',$a)
                                                    ->skip(0)->take(1)
                                                  ->where('local_id',$id)->pluck('amount')->sum(),2)
                                                     }}
                                                @endif
