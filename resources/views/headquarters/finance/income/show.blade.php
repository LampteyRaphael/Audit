...
@section('content')
    ...
    <div class="panel collapse" id="post">
        ...
        <div class="panel-body">
            <table class="table table-bordered mb0">
                <tbody>
                {!! Form::open(['method'=>'POST','action'=>'National\NationalIncomeController@store'] ) !!}

                <tr>
                    {!! Form::hidden('category_id',$category->id,['class'=>'form-control']) !!}
                    {!! Form::hidden('local_id',$id,['class'=>'form-control','required'=>'required']) !!}
    ...
    <div class="panel mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li>
                    <a href="{{route('categoryNa.index')}}">{{$category->name}}</a>
                </li>
                <li>
