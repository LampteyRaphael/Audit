...
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'National\NationalFinanceAreaController@yearareapost','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
    ...
    <div class="panel mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li><a href="{{route('NYear')}}" class="btn btn-default btn-xs">Go Back</a></li>
                <li>
                ...
                @if($areas)
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($areas as $area)
                            <tr>
                              <td><a href="{{route('nationalYearDistrict',$area->id)}}">{{$area->name}}</a></td>
