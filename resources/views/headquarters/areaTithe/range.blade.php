...
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'National\NationalFinanceAreaController@rangepost','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
    ...
    <div class="panel mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li><a href="{{route('NRange')}}" class="btn btn-xs btn-default">Go Back</a></li>
                <li>
                ...
                @if($areas)
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($areas as $area)
                            <tr>
                                <td><a class="btn-link" href="{{route('nationalRangeDistrict',$area->id)}}">{{$area->name}}</a></td>
                                <td>
                                    <?php
