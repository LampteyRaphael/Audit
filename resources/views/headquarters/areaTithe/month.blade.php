...
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'National\NationalFinanceAreaController@monthareapost','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
                ...
                <div class="form-group">
                    <label for="date" class="control-label">
                        <div class="input-group col-md-6 col-md-offset-3">
                            ...
                            {!! Form::selectMonth('month',$month,['class'=>'form-control selectpicker','multiple data-max-options'=>1,'data-live-search'=>'true']) !!}
                ...
                <div class="form-group">
                    <label for="date" class="control-label">
                        <div class="input-group col-md-6 col-md-offset-3">
                            ...
                            {!! Form::selectYear('year',2017,Carbon\Carbon::now()->year,$year,['class'=>'form-control selectpicker','multiple data-max-options'=>1,'data-live-search'=>'true']) !!}
    ...
    <div class="panel mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li><a href="{{route('NMonthly')}}" class="btn btn-default btn-xs">Go Back</a></li>
                <li>
                    <a href="javascript:;">{{$regionName->name}}</a>
                </li>
                <li>
                ...
                <li><a class="btn btn-sm btn-default" href="#date" data-toggle="modal">Change Date</a></li>
            </ol>
        </div>
                ...
                @if($areas)
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($areas as $area)
                            <tr>
                                <td>
                                    <a class="btn-link" href="{{route('nationalMonthDistricts',$area->id)}}">{{$area->name}}</a>
                                </td>
