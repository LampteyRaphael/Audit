...
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'National\NationalFinanceDistrictController@store','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
    ...
    <div class="panel mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li><a href="{{route('NAreaindex',Session::get('financeDailyAreaId'))}}" class="btn btn-xs btn-default">Go Back</a></li>
                <li>
                ...
                @if($districts)
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($districts as $district)
                            <tr>
                                <td>
                                    <a href="{{route('natFLocal',$district->id)}}">{{$district->name}}</a>
                                </td>
