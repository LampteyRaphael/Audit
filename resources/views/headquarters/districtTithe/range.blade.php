...
@section('content')
    {!! Form::open(['method'=>'POST','action'=>'National\NationalFinanceDistrictController@store3','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
    ...
    <div class="panel mb25">
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li>
                    <a href="{{route('nationalRangeArea',Session::get('financeRisAll'))}}" class="btn btn-xs btn-default">Go Back</a>
                </li>
                <li>
                ...
                @if($districts)
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($districts as $district)
                            <tr>
                                <td>
                                    <a href="{{route('natFLocalRange1',$district->id)}}">{{$district->name}}</a>
                                </td>
                                <td>
                                    <?php
