...
<div class="row">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-wrench"></i></div>
                        {!! Form::select('languagess[]',[''=>'Choose Options']+$languages,null,['id'=>'languagess',
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('members_id',null,['class'=>'form-control','required'=>'required', 'placeholder'=>$membershipId . "+3-digit only" ]) !!}
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        //
        //   li.innerText=document.getElementById('moreform').value;
        //
        // var ulli=ul.append(li);
        //
        // var moreform=document.createElement('moreform');
        //
        // var add=document.getElementById('add');
        //
        // add.addEventListener('click',function () {
        //
        //     moreform.append(ulli);
        // }) ;


    </script>

    {{--End Of Church Details--}}
