                ...
                <div class="col-4">
                    <div class="input-group form-control-lg">
                      ...
                      <span class="input-group-text">
                        ...
                        <div class="form-group bmd-form-group is-filled has-success">
                            {!! Form::label('courseStudied','Course Studied',['class'=>'bmd-label-floating font-weight-bold']) !!}
                ...
                <div class="col-4">
                    <div class="input-group form-control-lg">
                      ...
                      <span class="input-group-text">
                        ...
                        <div class="form-group bmd-form-group is-filled has-success">
                            {!! Form::label('employmentType','Employment Type',['class'=>'bmd-label-floating font-weight-bold']) !!}
                ...
                <div class="col-4">
                    <div class="input-group form-control-lg">
                      ...
                      <span class="input-group-text">
                        ...
                        <div class="form-group bmd-form-group is-filled has-success">
                            {!! Form::label('profOccupation','Profession/Occupation',['class'=>'bmd-label-floating font-weight-bold']) !!}
                ...
                <div class="col-4">
                    <div class="input-group form-control-lg">
                      ...
                      <span class="input-group-text">
                        ...
                        <div class="form-group bmd-form-group is-filled has-success">
                            {!! Form::label('placeOfWork','Place Of Work',['class'=>'bmd-label-floating font-weight-bold']) !!}
